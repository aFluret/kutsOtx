...
public class AdminController {
    ...
    public void initialize() {
        ...
        role.setItems(FXCollections.observableArrayList("admin", "user", "blocked"));
    ...
    public void ActionShowData(ActionEvent actionEvent) {
            ...
            try {
                ...
                informationController.setInformation();
                stage.show();
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void ViewCard(ActionEvent actionEvent) {
        ...
        if (selectedUser != null) {
            try {
                FXMLLoader load = new FXMLLoader();
                load.setLocation(getClass().getResource("/view/main_otx.fxml"));
                Parent root = load.load();
                Stage stage = new Stage();
                stage.setScene(new Scene(root));
                OtxInfoController otxInfoController = (OtxInfoController) load.getController();
                otxInfoController.setInformation(selectedUser);
                stage.show();
            } catch (IOException e) {
                e.printStackTrace();
            }
